...
public class SingleManipulationsStreamBasic {
    ...
    private static void arrayManipulation() {
        ...
        System.out.println("10. Return non-null array of String");
        String[] anw = Arrays.stream(arr).filter(Objects::nonNull).toArray(String[]::new);
        System.out.println("---------");

        System.out.println("11. Find frequency of each character in arr and ignore null");
        ...
        {
            char value = 'a';
            System.out.println("12. Find frequency of specific character across all String in arr and ignore null: " + value);
    ...
    private static void stringManipulation() {
...

        {
            ...
            Map<String, Long> map = Arrays.stream(input.split("")).filter(s -> !s.equals(" ")).map(String::toLowerCase).collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
            System.out.println(map);
            System.out.println("---------");
        ...
        {
            System.out.println("3. Find out frequency of each character preserve order");
        ...
        System.out.println("4. Find out repeating characters");
